 ...
 * @author gbarbieri
 */
public class FragmentPosition implements GLEventListener {
    ...
    public static void main(String[] args) {
        FragmentPosition tut02 = new FragmentPosition();

        Frame frame = new Frame("Tutorial 02 - Fragment Position");
    ...
    private void buildShaders(GL3 gl3) {
        ...
        programObject.attachVertexShader(gl3, shadersFilepath + "fragmentPosition_VS.glsl");
        programObject.attachFragmentShader(gl3, shadersFilepath + "fragmentPosition_FS.glsl");
