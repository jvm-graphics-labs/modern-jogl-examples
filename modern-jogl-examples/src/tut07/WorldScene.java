 ...
 * @author gbarbieri
 */
public class WorldScene implements GLEventListener, KeyListener {

    private int imageWidth = 800;
    private int imageHeight = 600;
    private GLCanvas canvas;
    private GLSLProgramObject_1 uniformColor;
    private GLSLProgramObject_1 objectColor;
    private GLSLProgramObject_1 uniformColorTint;
    ...
    public static void main(String[] args) {
        ...
        Frame frame = new Frame("Tutorial 07 - World Scene");

        frame.add(worldScene.getCanvas());

        frame.setSize(worldScene.getCanvas().getWidth(), worldScene.getCanvas().getHeight());
    ...
    public void display(GLAutoDrawable glad) {
        ...
        {
            gl3.glUniformMatrix4fv(uniformColor.getWorldToCameraMatUnLoc(), 1, false, camMatrix.top().toFloatArray(), 0);
        }
        objectColor.bind(gl3);
        {
            gl3.glUniformMatrix4fv(objectColor.getWorldToCameraMatUnLoc(), 1, false, camMatrix.top().toFloatArray(), 0);
        }
        uniformColorTint.bind(gl3);
        {
            gl3.glUniformMatrix4fv(uniformColorTint.getWorldToCameraMatUnLoc(), 1, false, camMatrix.top().toFloatArray(), 0);
        }
        ...
        if (drawLookAtPoint) {
            ...
            gl3.glDisable(GL3.GL_DEPTH_TEST);
            {
                ...
                modelMatrix.push();
                {
                    Vec3 cameraAimVec = camTarget.minus(camPos);
                    ...
                    objectColor.bind(gl3);
                    {
                        ...
                        gl3.glUniformMatrix4fv(objectColor.getWorldToCameraMatUnLoc(), 1, false, identity.toFloatArray(), 0);
    ...
    public void reshape(GLAutoDrawable glad, int x, int y, int w, int h) {
        ...
        uniformColor.bind(gl3);
        {
            gl3.glUniformMatrix4fv(uniformColor.getCameraToClipMatUnLoc(), 1, false, perspectiveMatrix.top().toFloatArray(), 0);
        }
        objectColor.bind(gl3);
        {
            gl3.glUniformMatrix4fv(objectColor.getCameraToClipMatUnLoc(), 1, false, perspectiveMatrix.top().toFloatArray(), 0);
        }
        uniformColorTint.bind(gl3);
        {
            gl3.glUniformMatrix4fv(uniformColorTint.getCameraToClipMatUnLoc(), 1, false, perspectiveMatrix.top().toFloatArray(), 0);
        }
        uniformColorTint.unbind(gl3);
    ...
    private void initializePrograms(GL3 gl3) {
        ...
        uniformColor = new GLSLProgramObject_1(gl3, shadersFilepath, "PosOnlyWorldTransform_VS.glsl", "ColorUniform_FS.glsl");
        objectColor = new GLSLProgramObject_1(gl3, shadersFilepath, "PosColorWorldTransform_VS.glsl", "ColorPassthrough_FS.glsl");
        uniformColorTint = new GLSLProgramObject_1(gl3, shadersFilepath, "PosColorWorldTransform_VS.glsl", "ColorMultUniform_FS.glsl");
    }
