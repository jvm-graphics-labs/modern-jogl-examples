 ...
 * @author gbarbieri
 */
public class MatrixPerspective implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        Frame frame = new Frame("Tutorial 04 - Matrix Perspective");

        frame.add(matrixPerspective.getCanvas());

        frame.setSize(matrixPerspective.getCanvas().getWidth(), matrixPerspective.getCanvas().getHeight());
