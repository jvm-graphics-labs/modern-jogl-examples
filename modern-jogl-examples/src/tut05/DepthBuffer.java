 ...
 * @author gbarbieri
 */
public class DepthBuffer implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        Frame frame = new Frame("Tutorial 05 - Depth Buffering");

        frame.add(depthBuffer.getCanvas());

        frame.setSize(depthBuffer.getCanvas().getWidth(), depthBuffer.getCanvas().getHeight());
