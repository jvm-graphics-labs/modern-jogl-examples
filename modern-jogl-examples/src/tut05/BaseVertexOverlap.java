 ...
 * @author gbarbieri
 */
public class BaseVertexOverlap implements GLEventListener {
    ...
    public static void main(String[] args) {
        BaseVertexOverlap baseVertexOverlap = new BaseVertexOverlap();

        Frame frame = new Frame("Tutorial 05 - Base Vertex with Overlap");

        frame.add(baseVertexOverlap.getCanvas());

        frame.setSize(baseVertexOverlap.getCanvas().getWidth(), baseVertexOverlap.getCanvas().getHeight());
