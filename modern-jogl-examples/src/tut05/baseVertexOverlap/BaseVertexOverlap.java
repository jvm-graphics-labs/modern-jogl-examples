...
public class BaseVertexOverlap extends Framework {
    ...
    private final float[] GREEN_COLOR = new float[]{0.75f, 0.75f, 1.0f, 1.0f},
            BLUE_COLOR = new float[]{0.0f, 0.5f, 0.0f, 1.0f}, RED_COLOR = new float[]{1.0f, 0.0f, 0.0f, 1.0f},
            GREY_COLOR = new float[]{0.8f, 0.8f, 0.8f, 1.0f}, BROWN_COLOR = new float[]{0.5f, 0.5f, 0.0f, 1.0f};
