 ...
 * @author gbarbieri
 */
public class VertexClipping implements GLEventListener {
    ...
    public static void main(String[] args) {
        VertexClipping vertexClipping = new VertexClipping();

        Frame frame = new Frame("Tutorial 05 - Vertex Clipping");

        frame.add(vertexClipping.getCanvas());

        frame.setSize(vertexClipping.getCanvas().getWidth(), vertexClipping.getCanvas().getHeight());
