...
public class OverlapNoDepth implements GLEventListener {
    ...
    private void initializeVertexArrayObjects(GL3 gl3) {
        ...
        gl3.glGenVertexArrays(2, IntBuffer.wrap(VAOs));
        gl3.glBindVertexArray(VAOs[0]);
        {
//        2 objects * 18 vertices * 3 coordinate * 4 Bytes/Float
        ...
        gl3.glBindVertexArray(VAOs[1]);
        {
            //  1 object * 18 vertices * 3 coordinates * 4 Bytes/Float
            positionDataOffset = 1 * 18 * 3 * 4;
            //  += 1 objects * 18 vertices * 4 coordinate * 4 Bytes/Float
            colorDataOffset += 1 * 18 * 4 * 4;

            gl3.glEnableVertexAttribArray(0);
            gl3.glEnableVertexAttribArray(1);
            {
                gl3.glVertexAttribPointer(0, 3, GL3.GL_FLOAT, false, 0, positionDataOffset);
                gl3.glVertexAttribPointer(1, 4, GL3.GL_FLOAT, false, 0, colorDataOffset);
            }
            gl3.glBindBuffer(GL3.GL_ELEMENT_ARRAY_BUFFER, IBO[0]);
        }
