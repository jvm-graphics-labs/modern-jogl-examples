 ...
 * @author gbarbieri
 */
public class fragChangeColor implements GLEventListener {
    ...
    public static void main(String[] args) {
        fragChangeColor changeColor = new fragChangeColor();

        Frame frame = new Frame("Tutorial 03 - Fragment Change Color");

        frame.add(changeColor.getCanvas());

        frame.setSize(changeColor.getCanvas().getWidth(), changeColor.getCanvas().getHeight());
    ...
    public void init(GLAutoDrawable glad) {
        ...
        programObject.bind(gl3);
        {
            ...
            programObject.setUniform(gl3, "fragLoopDuration", new float[]{10.0f}, 1);
        }
...
//        System.out.println("display");
    ...
    private void buildShaders(GL3 gl3) {
        ...
        programObject.attachFragmentShader(gl3, shadersFilepath + "calcColor_FS.glsl");
