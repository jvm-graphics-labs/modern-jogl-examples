...
void main()
{
    ...
    gaussianTerm = cosAngleIncidence != 0.0 ? gaussianTerm : 0.0;

    outputColor = (diffuseColor * attenuationIntensity * cosAngleIncidence) + (specularColor * attenuationIntensity * gaussianTerm) + (diffuseColor * lightAmbientIntensity);
}