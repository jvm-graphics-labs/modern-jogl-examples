 ...
 * @author gbarbieri
 */
public class DepthPeeling implements GLEventListener, KeyListener, MouseListener, MouseMotionListener {
...
//        System.err.println("   GL_VERSION_4_0: "+gl2.isExtensionAvailable("GL_VERSION_4_0"));
        ...
        try {
            ...
            Logger.getLogger(DepthPeeling.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void loadModel(GL2 gl2) throws FileNotFoundException, IOException {
