...
public class HelloTriangle extends Framework {
    ...
    private final String SHADERS_ROOT = "tut01";
    ...
    private void initializeProgram(GL3 gl3) {
        ...
        ShaderCode vertShaderCode = ShaderCode.create(gl3, GL_VERTEX_SHADER, getClass(), SHADERS_ROOT, null,
                VERT_SHADER_SOURCE, "vert", null, true);
        ShaderCode fragShaderCode = ShaderCode.create(gl3, GL_FRAGMENT_SHADER, getClass(), SHADERS_ROOT, null,
