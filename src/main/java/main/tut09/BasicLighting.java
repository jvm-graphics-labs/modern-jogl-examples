...
public class BasicLighting extends Framework {
    ...
    public void init(GL3 gl) {
        ...
        try {
            cylinderMesh = new Mesh(gl, getClass(), "tut09/UnitCylinder.xml");
            planeMesh = new Mesh(gl, getClass(), "tut09/LargePlane.xml");
    ...
    private void initializeProgram(GL3 gl) {
        whiteDiffuseColor = new ProgramData(gl, "tut09", "dir-vertex-lighting-PN.vert", "color-passthrough.frag");
        vertexDiffuseColor = new ProgramData(gl, "tut09", "dir-vertex-lighting-PCN.vert", "color-passthrough.frag");
    }
...
//                        .top().to(matBuffer);
//
//                System.out.println(objectPole.calcMatrix().toQuat());
//
//                if (drawColoredCyl) {
//
//                    gl.glUseProgram(vertexDiffuseColor.theProgram);
...
//            }
    ...
    public void reshape(GL3 gl3, int w, int h) {
        ...
        gl3.glBufferSubData(GL_UNIFORM_BUFFER, 0, Mat4.SIZE, perspMatrix.top().to(matBuffer));
