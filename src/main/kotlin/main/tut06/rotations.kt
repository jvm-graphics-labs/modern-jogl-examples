...
class Rotations_ : Framework("Tutorial 06 - Rotations") {
    ...
    val frustumScale = (1.0f / glm.tan(45f.rad / 2.0f))
    ...
    override fun display(gl: GL3) = with(gl) {
        ...
        for (currInst in instanceList) {

            val transformMatrix = currInst.constructMatrix(elapsedTime)
    ...
    override fun reshape(gl: GL3, w: Int, h: Int) = with(gl) {
        ...
        cameraToClipMatrix.a0 = frustumScale * (h / w.toFloat())
    ...
    class Instance(val calcRotation: (Float) -> Mat3, val offset: Vec3) {
