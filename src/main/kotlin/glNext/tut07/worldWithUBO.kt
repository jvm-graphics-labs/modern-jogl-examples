...
fun main(args: Array<String>) {
    WorldWithUBO_Next().setup("Tutorial 07 - World Scene")
}

class WorldWithUBO_Next : Framework() {
    ...
    override fun display(gl: GL3) = with(gl) {
        ...
        withUniformBuffer(globalMatricesBufferName) { subData(Mat4.SIZE, camMat) }
        ...
        modelMatrix apply {
            ...
            usingProgram(uniformColor.theProgram) {
                uniformColor.modelToWorldMatrixUnif.mat4 = top()
        ...
        if (drawLookAtPoint) {
            ...
            modelMatrix apply {
                ...
                usingProgram(objectColor.theProgram) {
                    objectColor.modelToWorldMatrixUnif.mat4 = top()
    ...
    fun drawTree(gl: GL3, modelStack: MatrixStack, trunkHeight: Float, coneHeight: Float) = with(gl) {
        ...
        modelStack apply {
            ...
            usingProgram(uniformColorTint.theProgram) {
                uniformColorTint.modelToWorldMatrixUnif.mat4 = top()
    ...
    override fun reshape(gl: GL3, w: Int, h: Int) = with(gl) {
        ...
        withUniformBuffer(globalMatricesBufferName) { subData(perspMatrix.top()) }
