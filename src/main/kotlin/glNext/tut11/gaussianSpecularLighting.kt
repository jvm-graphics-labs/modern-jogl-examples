...
import glNext.*
import glNext.tut11.GaussianSpecularLighting_Next.LightingModel.BlinnOnly
import glm.glm
...
import glNext.tut11.GaussianSpecularLighting_Next.LightingModel.BlinnSpecular
import glNext.tut11.GaussianSpecularLighting_Next.LightingModel.GaussianSpecular
import glNext.tut11.GaussianSpecularLighting_Next.LightingModel.PhongOnly
            ...
            if (drawLightSource)
                ...
                run {
                    ...
                    usingProgram(unlit.theProgram) {
                        unlit.modelToCameraMatrixUnif.mat4 = modelMatrix.top()
